...
mouseY = (e.changedTouches ? e.changedTouches[0].pageY : e.pageY) - this.offsetTop;
      ...
      var target = options.target || document.getElementById('canvasDiv')
			var outlineImageSrc = options.outlineImageSrc || "/lib/drawing/images/watermelon-duck-outline.png"
			...
			crayonImage.src = "/lib/drawing/images/crayon-outline.png";

			markerImage.onload = resourceLoaded;
			markerImage.src = "/lib/drawing/images/marker-outline.png";

			eraserImage.onload = resourceLoaded;
			eraserImage.src = "/lib/drawing/images/eraser-outline.png";

			crayonBackgroundImage.onload = resourceLoaded;
			crayonBackgroundImage.src = "/lib/drawing/images/crayon-background.png";

			markerBackgroundImage.onload = resourceLoaded;
			markerBackgroundImage.src = "/lib/drawing/images/marker-background.png";

			eraserBackgroundImage.onload = resourceLoaded;
			eraserBackgroundImage.src = "/lib/drawing/images/eraser-background.png";

			crayonTextureImage.onload = resourceLoaded;
			crayonTextureImage.src = "/lib/drawing/images/crayon-texture.png";
			...
			return {
				...
				setOutlineImage: setOutlineImage,
			}
		};
